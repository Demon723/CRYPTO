...
export function seedToRootNode(seed: Uint8Array): HDNode {
...
export function deriveChild(parent: HDNode, index: number): HDNode {
...
export function getAddress(publicKey: Uint8Array, scriptType: 'p2pkh' | 'p2wpkh' | 'p2tr' = 'p2pkh'): string {
...
export function getBIP44Address(node: HDNode, coinType: number = 0, account: number = 0, change: number = 0, addressIndex: number = 0): string {
...
function pbkdf2Derive(password: string, salt: string, iterations: number, keylen: number, hash: 'sha512'): Uint8Array {
  return pbkdf2Sync(password, salt, iterations, keylen, hash);
}
...
function privateKeyAdd(a: Uint8Array, b: Uint8Array): Uint8Array {
