...
const async_io_1 = require("../storage/async-io");
const io_uring_sim_1 = require("../storage/io-uring-sim");
function getTempDevicePath() {
...
async function testIOUringEngine() {
    ...
    const devicePath = getTempDevicePath();
    const fileIo = new async_io_1.AsyncFileIO(devicePath, 4096, 1024 * 1024);
    await fileIo.initialize();
    const engine = new io_uring_sim_1.IOUringEngine({ queueDepth: 256, batchSize: 64, pollIntervalMs: 1 }, fileIo);
