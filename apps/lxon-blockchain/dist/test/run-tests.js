...
async function testWasmGovernance() {
    ...
    const proposalResult = governance.createUpgradeProposal('test_module', '1.0.1', { name: 'test_module', version: '1.0.1', wasmPath: path.join(os.tmpdir(), 'test.wasm') }, 'validator-1');
...
async function testStorageEngine() {
    ...
    const storage = new storage_1.MonadDBStorageEngine('/dev/mock-device');
