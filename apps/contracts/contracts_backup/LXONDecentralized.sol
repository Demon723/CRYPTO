 ...
 */
contract LXONDecentralized is ERC20Votes, ERC20Burnable, Pausable, AccessControl, EIP712 {
     ...
     */
    constructor() ERC20(NAME, SYMBOL) EIP712(NAME, "1") {
        ...
        onlyRole(EMERGENCY_ROLE) 
    {
        ...
        emit EmergencyOverrideExecited(role, account, msg.sender);
    }
