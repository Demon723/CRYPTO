...
async function main() {
    ...
    try {
        ...
        console.log(`   RPC: ${config_1.FOUNDER_CONFIG.rpcUrl}`);
        console.log(`   PBT: ${config_1.FOUNDER_CONFIG.pbtAddress}`);
        console.log(`   Card Registry: ${config_1.FOUNDER_CONFIG.cardRegistryAddress}\n`);
    }
    catch (error) {
